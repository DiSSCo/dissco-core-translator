...
public class SourceSystem extends TableImpl<SourceSystemRecord> {
   ...
   */
  public final TableField<SourceSystemRecord, String> DESCRIPTION = createField(
   ...
   */
  public final TableField<SourceSystemRecord, Instant> DELETED = createField(DSL.name("deleted"),
