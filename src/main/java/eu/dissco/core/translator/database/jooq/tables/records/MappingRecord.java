...
public class MappingRecord extends UpdatableRecordImpl<MappingRecord> implements
    Record9<String, Integer, String, String, JSONB, Instant, String, Instant, String> {
