...
class EmlComponentTest {
  ...
  private static DataSets.DataSet generateFullDataset() throws DatatypeConfigurationException {
    ...
    var date
        ...
        .newXMLGregorianCalendar(Instant.parse("2025-06-26T00:00:00Z").toString());
